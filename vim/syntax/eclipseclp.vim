...
syn keyword  prologKeyword  module meta_predicate multifile dynamic lib
...
if !exists("prolog_highlighting_clean")
  ...
  syn keyword prologKeyword   get_min get_max
  syn keyword prologKeyword   dim for fromto param length eval array_list atom_string foreach

  syn match   prologOperator "=\\=\|=:=\|\\==\|=<\|==\|>=\|\\=\|\\+\|<\|>\|="
  syn match   prologOperator "$=\|::\|\.\.\|#=\|->\| do "
  syn match   prologAsIs     "===\|\\===\|<=\|=>"

  syn match   prologNumber            "\<[0123456789'ABCDEF]*\>'\@!"
...
let b:current_syntax = "eclipseclp"
